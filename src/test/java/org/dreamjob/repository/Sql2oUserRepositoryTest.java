...
import org.dreamjob.configuration.DatasourceConfiguration;
...
class Sql2oUserRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        User user = sql2oUserRepository.save(new User("user@user.ru",
                "user", "pass")).get();
    ...
    public void whenSaveThenFindUserByEmailAndPassword() {
        ...
        User user = sql2oUserRepository.save(new User(email, "user", password)).get();
    ...
    public void whenSaveTwoUsersWithEqualsEmailThen() {
        String email = "user@user.ru";
        User user1 = new User(email, "user1", "pass1");
        User user2 = new User(email, "user2", "pass2");
